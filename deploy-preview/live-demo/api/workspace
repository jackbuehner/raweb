    ...
    <Resources>
      <Resource ID="notepad" Alias="managed-resources/notepad" Title="Notepad" Type="RemoteApp" LastUpdated="2026-08-01T12:00:00Z">
        <HostingTerminalServer>
          ...
          <ResourceFile URL="/deploy-preview/live-demo/api/resources/managed-resources/notepad?from=mr&amp;features=supportsWake" FileExtension=".rdp" />
        </HostingTerminalServer>
        ...
        <Icons>
          <Icon FileType="Png" FileURL="/deploy-preview/live-demo/api/resources/image/managed-resources/notepad?format=png" Dimensions="64x64" />
        </Icons>
      </Resource>
      <Resource ID="excel" Alias="managed-resources/excel" Title="Excel" Type="RemoteApp" LastUpdated="2026-08-01T12:00:00Z">
        <HostingTerminalServer>
          <TerminalServerRef Ref="ts01.demo.raweb.local" />
          <ResourceFile URL="/deploy-preview/live-demo/api/resources/managed-resources/excel?from=mr" FileExtension=".rdp" />
        </HostingTerminalServer>
        ...
        <Icons>
          <Icon FileType="Png" FileURL="/deploy-preview/live-demo/api/resources/image/managed-resources/excel?format=png" Dimensions="64x64" />
        </Icons>
      </Resource>
      <Resource ID="accounting-desktop" Alias="managed-resources/accounting-desktop" Title="Accounting Desktop" Type="Desktop" LastUpdated="2026-08-01T12:00:00Z">
        <HostingTerminalServer>
          ...
          <ResourceFile URL="/deploy-preview/live-demo/api/resources/managed-resources/accounting-desktop?from=mr&amp;features=supportsWake" FileExtension=".rdp" />
        </HostingTerminalServer>
        <Folders>
          <Folder Name="/Desktops" />
        </Folders>
        <Icons>
          <Icon FileType="Png" FileURL="/deploy-preview/live-demo/api/resources/image/managed-resources/accounting-desktop?format=png&amp;frame=pc" Dimensions="512x320" />
        </Icons>
      </Resource>
      <Resource ID="gis-server" Alias="managed-resources/GIS Server" Title="GIS Server" Type="Desktop" LastUpdated="2026-08-01T12:00:00Z">
        <HostingTerminalServer>
          ...
          <ResourceFile URL="/deploy-preview/live-demo/api/resources/managed-resources/GIS%20Server?from=mr&amp;features=supportsWake" FileExtension=".rdp" />
        </HostingTerminalServer>
        <Folders>
          <Folder Name="/Desktops" />
        </Folders>
        <Icons>
          <Icon FileType="Png" FileURL="/deploy-preview/live-demo/api/resources/image/managed-resources/GIS%20Server?format=png&amp;frame=pc" Dimensions="512x320" />
        </Icons>
      </Resource>
      <Resource ID="davinci-resolve" Alias="managed-resources/DaVinci Resolve" Title="DaVinci Resolve" Type="RemoteApp" LastUpdated="2026-08-01T12:00:00Z">
        <HostingTerminalServer>
          ...
          <ResourceFile URL="/deploy-preview/live-demo/api/resources/managed-resources/DaVinci%20Resolve?from=mr" FileExtension=".rdp" />
        </HostingTerminalServer>
        <Folders>
          <Folder Name="/" />
        </Folders>
        <Icons>
          <Icon FileType="Png" FileURL="/deploy-preview/live-demo/api/resources/image/managed-resources/DaVinci%20Resolve?format=png" Dimensions="64x64" />
        </Icons>
      </Resource>
    </Resources>
  </Publisher>
